...
1. Run `bash .claude/ctx-protocol/scripts/print_handoff_content.sh` with the Bash tool. It prints the saved handoff for the current project + branch, or a fallback message if none exists.
